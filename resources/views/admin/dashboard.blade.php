...
<div class="bg-white rounded shadow p-8">
    ...
    <div class="grid grid-cols-2 gap-4 mt-6">
        ...
        <a href="{{ route('admin.educations.index') }}" class="p-4 bg-yellow-500 text-white rounded shadow hover:bg-yellow-600">
            مدیریت آموزش‌ها
        </a>
        <a href="{{ route('admin.biography.index') }}" class="p-4 bg-pink-500 text-white rounded shadow hover:bg-pink-600">
            ویرایش بیوگرافی
        </a>
        <a href="{{ route('admin.contacts.index') }}" class="p-4 bg-purple-500 text-white rounded shadow hover:bg-purple-600">
            پیام‌های تماس
        </a>
    </div>
</div>
